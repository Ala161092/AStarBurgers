    ...
    <div className='menu-wrapper'>    
      ...
      <Card>
          ...
          <Card.Subtitle>Devonshire home cooked Beef Burger</Card.Subtitle>
              ...
              <ul>
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Smokey Bacon</li>
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Kerry-maid Irish Cheese</li>
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Sizzling Spanish Onions</li>
              </ul>
      ...
      <Card>
          ...
          <Card.Subtitle>Devonshire home cooked Beef Burger</Card.Subtitle>
              ...
              <ul>
                  ...
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Kerry-maid Irish Cheese</li>
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Sizzling Spanish Onions</li>
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Hot Chips</li>
              </ul>
          <Card.Text className='text-bottom'>Served in a fresh baked seedy Bap</Card.Text>
      </Card>
      <Card>
          ...
          <Card.Subtitle>Devonshire home cooked Double Beef Burger</Card.Subtitle>
              ...
              <ul>
                  ...
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Kerry-maid Irish Cheese</li>
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Sizzling Spanish Onions</li>
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Golden Hash Brown</li>
              </ul>
          <Card.Text className='text-bottom'>Served in a fresh baked seedy Bap</Card.Text>
      </Card>
      <Card>
      ...
      <Card>
          ...
          <Card.Subtitle>Crispy Crumb Coated Veggie Burger</Card.Subtitle>
              ...
              <ul>
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Golden Hash Brown</li>
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Battered Onion Rings</li>
                  <li><FaPlusCircle fontSize='15px' color='#ef7631'/> Sizzling Spanish Onions</li>
              </ul>
          <Card.Text className='text-bottom'>Served in a fresh baked seedy Bap</Card.Text>
      </Card>
